...
bin 경로에서 ./startup.sh 명령어로 tomcat 실행 (종료: ./shutdown.sh) </br>
...
Tomcat Manager를 이용할 경우 /apache-tomcat-9.0.83/conf 경로의 tomcat-users.xml 파일 수정 </br>

<img width="600" alt="스크린샷 2023-12-17 오후 5 27 04" src="https://github.com/daily1313/algorithm/assets/88074556/c5eed1d3-408a-4650-879d-0ec9461ebcd9"> </br>
